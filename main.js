...
function toggleCarritoAside(){const isMobileMenuClosed=mobileMenu.classList.contains('inactive');
    if(!isMobileMenuClosed){mobileMenu.classList.add('inactive');}

    const ispro=productDetailContainer.classList.contains('inactive');
    if(!ispro){productDetailContainer.classList.add('inactive');}
